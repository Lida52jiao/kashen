        ...
        <div class="row">
            ...
            <div class="col-sm-5">
                <form method="post" action="login.shtml">
                    <p class="m-t-md">登录到运营管理后台</p>
                    <input type="text" class="form-control uname" name="accountName" value="" placeholder="用户名" />
                    <input type="password" class="form-control pword m-b" name="passWord" value="" placeholder="密码" />

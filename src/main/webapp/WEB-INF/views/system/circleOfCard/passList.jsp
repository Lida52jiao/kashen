	...
	<div class="ibox float-e-margins">
		<div class="ibox-content">
			...
			<div class="table-responsive">
				<table id="pass" data-toolbar="#toolbar"
...
<script type="text/javascript">
	function getPass() {
		return $.map($("#pass").bootstrapTable('getSelections'), function(
				row) {
			return row.id
		});
	}
	...
	$('#pass').bootstrapTable({
		url : rootPath + '/Circle/getPassList.shtml?shows='+'T',
		height : '100%',
		sortName : 'id',
		sortOrder : 'desc',

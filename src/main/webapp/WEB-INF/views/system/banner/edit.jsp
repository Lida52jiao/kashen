			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="radio i-checks">
                      	<label><input type="radio" value="0" name="status" class="banner"> <i></i> 首页(1080*512)</label>
                      	<label><input type="radio" value="1" name="status" class="banner"> <i></i> 信用卡申请(206*240)</label>
                      	<label><input type="radio" value="2" name="status" class="banner"> <i></i> 用卡百科(480*228)</label>
                      	<label><input type="radio" value="3" name="status" class="banner"> <i></i> 广告位(192*240)</label>

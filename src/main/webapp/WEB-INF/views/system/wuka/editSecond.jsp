...
<div class="ibox float-e-margins">
	<div class="ibox-content">
		<form class="form-horizontal m-t required-validate" id="editSecondWuka">
...
<script type="text/javascript">
 ...
 $(function(){
  	save = function(obj) {
  		if($("#editSecondWuka").valid()){
  			$.ajax({
				type: "POST", 
				url: rootPath + "/Wuka/alterSecond.shtml",
				data: $('#editSecondWuka').serializeArray(),

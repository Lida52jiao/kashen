...
<div class="wrapper wrapper-content animated fadeInRight"
	...
	<div class="ibox float-e-margins">
		<div class="ibox-content">
			...
			<form role="form" class="form-inline" id="userSearchFormsecondWuka">
			...
			<div class="form-group">
				...
				<div class="input-group">
						<button type="button" class="btn btn btn-primary"
							onclick="javascript:secondSearchWuka();">
			...
			<div class="table-responsive">
				<table id="secondWuka" data-toolbar="#toolbar"
...
<script type="text/javascript">
	function getUserIdSelectionssecondWuka() {
		return $.map($("#secondWuka").bootstrapTable('getSelections'), function(
				row) {
			return row.oId
		});
	}
	function editWukaSecond() {
		var cbox = getUserIdSelectionssecondWuka();
		if (cbox == "") {
			layer.msg("请选择编辑项！！");
			return;
		}
		...
		battcn.ajaxOpen({
			title : '审核',
			href : rootPath + '/Wuka/editSecond.shtml?id=' + cbox,
			width : '40%',
			height : '80%',
			okhandler : function() {
				save();
	...
	function secondSearchWuka() {
		$('#secondWuka').bootstrapTable('refresh');
	}
	//重写参数传递
	...
	$('#secondWuka').bootstrapTable({
		url : rootPath + '/Wuka/getsecondList.shtml',
		height : '100%',
		sortName : 'id',
		sortOrder : 'desc',

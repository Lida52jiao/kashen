...
<div class="wrapper wrapper-content animated fadeInRight"
	...
	<div class="ibox float-e-margins">
		<div class="ibox-content">
			...
			<form role="form" class="form-inline" id="userSearchFormfirstWuka">
			...
			<div class="form-group">
				...
				<div class="input-group">
						<button type="button" class="btn btn btn-primary"
							onclick="javascript:firstSearchWuka();">
			...
			<div class="table-responsive">
				<table id="firstWuka" data-toolbar="#toolbar"
...
<script type="text/javascript">
	function getUserIdSelectionsfirstWuka() {
		return $.map($("#firstWuka").bootstrapTable('getSelections'), function(
				row) {
			return row.oId
		});
	}
	function editWukaFirst() {
		var cbox = getUserIdSelectionsfirstWuka();
		if (cbox == "") {
			layer.msg("请选择编辑项！！");
			return;
		}
		...
		battcn.ajaxOpen({
			title : '审核',
			href : rootPath + '/Wuka/editFirst.shtml?id=' + cbox,
			width : '40%',
			height : '80%',
			okhandler : function() {
				save();
	...
	function firstSearchWuka() {
		$('#firstWuka').bootstrapTable('refresh');
	}
	//重写参数传递
	 function queryParamsfirstWuka(params) {
	...
	$('#firstWuka').bootstrapTable({
		url : rootPath + '/Wuka/getfirstList.shtml',
		height : '100%',
		sortName : 'id',
		sortOrder : 'desc',
		...
		queryParams : queryParamsfirstWuka,//参数处理函数

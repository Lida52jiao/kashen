...
<div class="wrapper wrapper-content animated fadeInRight"
	...
	<div class="ibox float-e-margins">
		<div class="ibox-content">
			...
			<form role="form" class="form-inline" id="userSearchFormfirst">
			...
			<div class="form-group">
				...
				<div class="input-group">
						<button type="button" class="btn btn btn-primary"
							onclick="javascript:firstSearch();">
			...
			<div class="table-responsive">
				<table id="first" data-toolbar="#toolbar"
...
<script type="text/javascript">
	function getUserIdSelectionsfirst() {
		return $.map($("#first").bootstrapTable('getSelections'), function(
				row) {
			return row.oId
		});
	}
	function editFirst() {
		var cbox = getUserIdSelectionsfirst();
		if (cbox == "") {
			layer.msg("请选择编辑项！！");
			return;
		}
		...
		battcn.ajaxOpen({
			title : '审核',
			href : rootPath + '/WithdrawEntity/editFirst.shtml?id=' + cbox,
			width : '40%',
			height : '80%',
			okhandler : function() {
				save();
	...
	//重写参数传递
	 function queryParamsfirst(params) {
	...
	$('#first').bootstrapTable({
		url : rootPath + '/WithdrawEntity/getfirstList.shtml',
		height : '100%',
		sortName : 'id',
		sortOrder : 'desc',
		...
		queryParams : queryParamsfirst,//参数处理函数

...
<div class="wrapper wrapper-content animated fadeInRight"
	...
	<div class="ibox float-e-margins">
		<div class="ibox-content">
			...
			<form role="form" class="form-inline" id="userSearchFormWithdrawEntity">
				...
				<div class="input-group">
					<input type="text" placeholder="输入结算单号" name="orderNo" id="orderNo"
						class="input form-control"> <span class="input-group-btn">
					</span>
				</div>
				<div class="input-group">
				...
				<div class="input-group">
					<input type="text" placeholder="输入商户名称" name="merchantName" id="merchantName"
						class="input form-control"> <span class="input-group-btn">
					</span>
				</div>
				<div class="input-group">
					<input type="text" placeholder="输入结算卡号" name="cardNo" id="cardNo"
						class="input form-control"> <span class="input-group-btn">
					</span>
				</div>
				<div class="input-group">
			...
			<div class="form-group">
				...
				<div class="input-group">
						<button type="button" class="btn btn btn-primary"
							onclick="javascript:withdrawEntitySearch();">
			...
			<div class="table-responsive">
				<table id="withdrawEntity" data-toolbar="#toolbar"
...
<script type="text/javascript">
	function getUserIdSelectionsWithdrawEntity() {
		return $.map($("#withdrawEntity").bootstrapTable('getSelections'), function(
				row) {
			return row.id
		});
	}
	...
	function withdrawEntitySearch() {
		$('#withdrawEntity').bootstrapTable('refresh');
	}
	//重写参数传递
	 function queryParamswithdrawEntity(params) {
	...
	$('#withdrawEntity').bootstrapTable({
		url : rootPath + '/WithdrawEntity/getWithdrawList.shtml',
		height : '100%',
		sortName : 'id',
		sortOrder : 'desc',
		...
		queryParams : queryParamswithdrawEntity,//参数处理函数

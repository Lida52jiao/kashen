...
public class ResourcesController extends BaseController {
	...
	public String addUI(Model model, Long id) {
		...
		if (id != null) {
			...
			entity.setDescription(CommonUtil.htmltoString(entity
					.getDescription()));
	...
	public String permissions(Model model) {
		List<ResourcesEntity> list = this.resourcesService
				.queryResourcesForList();
		List<ResourcesEntity> ns = TreeUtil.getChildResourceForms(list, Long.parseLong("0"));
	...
	@SystemLog(module = "系统管理", methods = "用户管理/角色管理-修改权限")
	// 凡需要处理业务逻辑的.都需要记录操作日志
	public String editRoleRes(String userId, String roleId, Integer[] resId)
			throws Exception {

...
public class YJ {
	...
	public static Logger getLog() {
		return Logger.getLogger(YJ.class);
	}
	 ...
	 * @return PushPayload
	 */
	public static PushPayload build(String alias, String alert) {
		return PushPayload
				.newBuilder()
	 ...
	 * @return PushResult
	 */
	public static PushResult pushAll(String alias, String alert, String Secret, String APPKEY) {
		JPushClient jpushClient = new JPushClient(Secret, APPKEY, null,ClientConfig.getInstance());
		PushPayload payload = build(alias, alert);
		try {
	 ...
	 * @return PushResult
	 */
	public static PushResult push(String alias, String alert, String Secret, String APPKEY) {
		JPushClient jpushClient = new JPushClient(Secret, APPKEY, null,ClientConfig.getInstance());

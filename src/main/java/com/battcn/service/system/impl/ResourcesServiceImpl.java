...
@Service
public class ResourcesServiceImpl extends BaseServiceImpl<ResourcesEntity>
	...
	public String updateGroupByRole(String userId, String roleId,
			Integer[] resId) {
		try {
	...
	public List<String> findRoleNameByUserId(String userId) {
		return this.resourcesMapper.findRoleNameByUserId(userId);
	}
}
